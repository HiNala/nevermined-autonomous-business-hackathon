// Undermind v3.2.0 — VISION + Blob storage integration
...
export const metadata: Metadata = {
  title: {
    default: "Undermind — AI Agent Studio",
    template: "%s | Undermind",
  },
  description: SITE_DESCRIPTION,
  metadataBase: new URL(BASE_URL),
  openGraph: {
    title: "Undermind — AI Agent Studio",
