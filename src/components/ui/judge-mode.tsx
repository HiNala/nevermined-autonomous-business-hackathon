...
export const JUDGE_PRESETS: JudgePreset[] = [
  {
    ...
    subtitle: "Interpreter → Composer → Buyer → packaged report",
  ...
  {
    id: "buy-external",
    title: "Buyer Enrichment (Live)",
    subtitle: "Buyer purchases marketplace assets — External Marketplace ON",
  ...
  {
    id: "seller-live",
    title: "Seller Live Order",
    subtitle: "Agentic seller flow — Buyer enrichment enabled via Nevermined",
    prompt: "Generate a comprehensive market analysis report on SaaS pricing models in 2025: trends, value metrics, competitive dynamics, and buyer psychology.",
    mode: "seller",
    outputType: "analysis",
    toolOverrides: {
      researcher: { search: "apify", scrape: "apify" },
